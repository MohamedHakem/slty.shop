    ...
    <div dir="rtl" className="flex flex-col items-center">
      <div className="w-full h-full bg-gradient-to-b from-white via-beige to-white gap-4 px-5 md:px-0">
        ...
        <div className="flex items-center justify-center h-full w-full pt-16 md:pt-20 pb-4">
          <h1 className={cn("text-[38px] md:text-[50px] text-black leading-relaxed font-extrabold max-w-[57rem] text-center", AlmaraiFont.className)}>
          ...
          <span className="relative whitespace-nowrap mr-1 px-[6px]">
            <span className="absolute bg-black h-[64px] -top-2 -bottom-1 -left-2 -right-2
        ...
        <div className="flex flex-col items-center justify-center h-full w-full pt-3 pb-4 md:pb-6 gap-6 md:gap-5">
          <p className={cn("text-lg md:text-2xl text-black/80 font-semibold max-w-[39rem] text-center md:leading-[2.75rem]", AlmaraiFont.className)}>
            مع منصة
            ...
            ،
            واربط منتجاتك بحلول ذكيَّة لزيادة مبيعاتك حتي
          ...
          <div className={cn("flex gap-4 text-base text-black/80 leading-normal font-medium", AlmaraiFont.className)} >
            ...
            <div className="flex gap-[6px] max-w-3xl text-center justify-center items-center">
              <span className="flex rounded-full w-[20px] h-[20px] bg-green-500 items-center justify-center">
                <FcCheckmark color="#ffffff" size={12} strokeWidth={5} />
              </span>
              <p>30 أداة مجانية</p>
