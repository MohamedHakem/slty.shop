    ...
    <main className="w-full h-full min-h-screen mx-auto flex flex-col relative">
      ...
      <div className="w-full h-full mx-auto flex flex-col relative justify-center items-center">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white font-bold">
          <div className="w-3/4 md:w-[520px] h-56 md:h-72 justify-center items-center text-center flex flex-col rounded-3xl text-white gap-6 md:gap-8 bg-slate-400/80 backdrop-blur-2xl p-4">
            <h2 className="text-3xl md:text-4xl font-bold">Not Found!</h2>
            <p className="text-base md:text-2xl font-bold">Could not find requested resource</p>
            <div>
              <span className="mr-8 text-xl md:text-2xl font-bold">Go to</span>
              <Link href="/">
