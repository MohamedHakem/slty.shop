export const SellerBuyerSafetyNotice = () => { 
  return (
    <div className="flex flex-col gap-2 p-3 md:p-4 border rounded-xl text-[#dc7609] bg-[#fffbf7]">
      <h2 className="inline text-xl font-medium">سلامتك تهمنا</h2>
      <ul className="list-disc *:list-inside flex flex-col gap-1 text-[#dc6809] ">
