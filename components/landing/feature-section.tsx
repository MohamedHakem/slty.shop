...
export default function FeatureSection({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full pt-3 pb-4 m-auto max-w-[72rem] gap-4 md:pb-6">
      <h2 className="text-4xl md:text-6xl text-blacker/90 font-semibold text-center md:leading-[2.75rem]">
        {title}
      </h2>

      {description ?
        <h3 className="text-2xl md:text-3xl text-black/60 font-semibold text-center md:leading-[2.75rem] md:mt-4">
          {description}
        </h3>
        : <></>
      }
